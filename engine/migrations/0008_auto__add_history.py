...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'engine_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('choice', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('beer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['engine.Beer'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'engine', ['History'])


    def backwards(self, orm):
        # Deleting model 'History'
        db.delete_table(u'engine_history')
