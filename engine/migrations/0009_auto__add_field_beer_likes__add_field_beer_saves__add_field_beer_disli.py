...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beer.likes'
        db.add_column(u'engine_beer', 'likes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Beer.saves'
        db.add_column(u'engine_beer', 'saves',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Beer.dislikes'
        db.add_column(u'engine_beer', 'dislikes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beer.likes'
        db.delete_column(u'engine_beer', 'likes')

        # Deleting field 'Beer.saves'
        db.delete_column(u'engine_beer', 'saves')

        # Deleting field 'Beer.dislikes'
        db.delete_column(u'engine_beer', 'dislikes')
